        ...
        <div class="nav-background">
            ...
            <div class="mobile-nav">
                ...
                <div class="contact flex items-center">
                    ...
                    <div>
                        <h5>Call us: (+92) 323-213-2362</h5>
                        <h6>E-mail : www.shabirbalochgamer2000@gmail.com</h6>
                    </div>
                </div>
                <div class="time flex items-center">
                    ...
                    <div>
                        <h5>Working Hours:</h5>
                        <h6>Mon,Tue,Wed,Thu,Fri,Sat (8.00am - 12.00am)</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="site-content">
                ...
                <header class="hero flex items-center">
                    <div class="container">
                        ...
                        <h1>SITE BY <span>SHABIR BALOCH</span> HACKER</h1>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            been the
                            industry's standard dummy.</p>
                        <div>
                            <button class="btn btn-primary">Read More</button>
                            <button class="btn btn-secondary">ENJOY</button>
                        </div>
                ...
                <section class="top-products">
                    <div class="container">
                        <h1 class="section-heading">PIC OF JUNAID JAMSHED</h1>
                        <div class="slider">
                            ...
                            <div class="food-slider">
                                <div class="food-card magic-shadow-sm">
                                    <div class="product-image flex items-center justify-center">
                                        <img src="./images/junaid1.jpg" alt="">
                                    </div>
                                    <hr>
                                    <div>
                                        <h2 class="text-center">JUNAID JAMSHED KHAN</h2>
                                ...
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center">JUNAID JAMSHED SHAEED</h2>
                                        <div class="stars flex justify-center items-center">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                ...
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center">Crypto Currency India</h2>
                                        <div class="stars flex justify-center items-center">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                ...
                                <div class="food-card magic-shadow-sm">
                                    <div class="product-image flex items-center justify-center">
                                        <img src="./images/junaid2.jpg" alt="">
                                    </div>
                                    <hr>
                                    <div>
                                        <h2 class="text-center">JUNAID JAMSHED</h2>
                                        <div class="stars flex justify-center items-center">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                ...
                <section class="About Hacker's Site">
                    <div class="container">
                        <h1 class="section-heading">About Shabir Baloch Website</h1>
                        <div class="about-meal-wrap flex">
                            <div class="flex-1">
                                <img src="./images/junaid3.jpg" alt="">
                            </div>
                            <div class="flex-1">
                                <h2>Shabir Baloch Hacker</h2>
                                <p> SHABIR BALOCH PAKISTANI ETICAL HACKER AND A PROGRAMMER.
                                      </p>
                ...
                <section class="our-services">
                    <div class="container">
                        <h1 class="section-heading">Coming Soon...</h1>
                        <div class="card-wrapper flex">
                            ...
                            <div class="service-card magic-shadow-sm">
                                ...
                                <h2 class="text-primary">Available Very Soon..</h2>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                <button class="btn btn-primary">Read More</button>
                            </div>
                            <div class="service-card magic-shadow-sm">
                ...
                <section class="More Info">
                    <div class="container">
                        <h1 class="section-heading text-pure">Latest News Of Site</h1>
                              <div class="timer">
                            <div>
                                <span>02</span>
                                <span>Days</span>
                    ...
                    <div class="container">
                        ...
                        <div class="article-wrapper">
                            <article class="card magic-shadow-sm">
                                <div>
                                    <img src="./images/junaid5.jpg" alt="">
                                </div>
                                <div class="card-content">
                                    <div class="post-meta flex items-center justify-between">
                                        <span>Jan 31, 2021</span>
                                        <div>
                                            <span>Posted by <strong>Hacker Site</strong></span>
                                            <span class="comment-count">876 Comments</span>
                                        </div>
                                    </div>
                            ...
                            <article class="card magic-shadow-sm">
                                ...
                                <div class="card-content">
                                    <div class="post-meta flex items-center justify-between">
                                        ...
                                        <div>
                                            <span>Posted by <strong>Hacker Site</strong></span>
                                            <span class="comment-count">1276 Comments</span>
                                        </div>
                                    </div>
                ...
                <section class="subscribe">
                    <div class="container flex items-center">
                        ...
                        <div>
                            ...
                            <p> tiktok.com/@dashi.asif.dahar
                                 
                                  </p>
                            <div class="input-wrap">
                                <input type="email" placeholder="www.Royaldeshi110@gmail.com">
                        ...
                        <div class="contact-info">
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span>E-mail ::</span>
                                        <span>www.shabirbalochgamer2000@gmail.com</span>
                                    </div>
                                </div>
                                <div>
                        ...
                        <div class="box">
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://twitter.com/SHABIRB29236088">
                                    ...
                                    <li>
                                        <a href="https://youtube.com/channel/UCRnpWUOCz3Sb1RAX3GK4r0A">
                ...
                <footer class="copyright">
                    <div>
                        Copyright © 2021 .All rights reserved by <a href="https://youtube.com/channel/UCRnpWUOCz3Sb1RAX3GK4r0A">Coder Baloch</a>.
                    </div>
                </footer>
            </div>
        </div>
